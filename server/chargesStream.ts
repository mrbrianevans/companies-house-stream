...
const sampleChargeEvents: ChargesEvent.ChargesEvent[] = [
    {
        ...
        "data": {
            ...
            "transactions": [{
                ...
                "links": {"filing": "/company/02727406/filing-history/MzIxMTI1MDI2MWFkaXF6a2N4"}
            }, {
                "delivered_on": "2021-01-25",
                "filing_type": "charge-satisfaction",
                "links": {"filing": "/company/02727406/filing-history/MzI4OTU0NTI0M2FkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632970, "published_at": "2021-01-25T12:22:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/03113932/filing-history/MzI4OTQxMzY1MWFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632972, "published_at": "2021-01-25T12:23:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/08032632/filing-history/MzI4OTQyODgzN2FkaXF6a2N4"}
            }, {
                "delivered_on": "2021-01-25",
                "filing_type": "charge-satisfaction",
                "links": {"filing": "/company/08032632/filing-history/MzI4OTU0NTIxOGFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632963, "published_at": "2021-01-25T12:22:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/03995149/filing-history/MzI4OTQwNzk3MmFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632974, "published_at": "2021-01-25T12:24:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "particulars": {
                "contains_negative_pledge": true,
                "description": "All that leasehold property known as 55 great central, chatham street, sheffield, S3 8FG.",
                "type": "brief-description"
            },
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/11150706/filing-history/MzI4OTQyNTMxNmFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632980, "published_at": "2021-01-25T12:25:02", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/12284440/filing-history/MzI4OTQzMjM3OWFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632986, "published_at": "2021-01-25T12:26:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/11972998/filing-history/MzI4OTQwNDc4MGFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632984, "published_at": "2021-01-25T12:26:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/12005578/filing-history/MzI4OTQwMTk1NGFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632988, "published_at": "2021-01-25T12:27:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "particulars": {
                "contains_fixed_charge": true,
                "contains_negative_pledge": true,
                "description": "The leasehold property known as 92 walkden road, walkden, manchester M28 3DY demised by a lease made between mr. R. nuttall and mr. V. berry which is to be allocated a title number upon registration of the abovementioned lease out of the head leasehold title number GM905652 .",
                "type": "brief-description"
            },
            ...
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/11663349/filing-history/MzI4OTQyMTE3NWFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632993, "published_at": "2021-01-25T12:28:01", "type": "changed"}
    },
    {
        "resource_kind": "company-charges",
        ...
        "data": {
            ...
            "particulars": {"contains_fixed_charge": true, "contains_negative_pledge": true},
            "persons_entitled": [{"name": "Investec Bank (Channel Islands) Limited"}],
            "status": "outstanding",
            "transactions": [{
                "delivered_on": "2021-01-22",
                "filing_type": "create-charge-with-deed",
                "links": {"filing": "/company/05144097/filing-history/MzI4OTQyNTk4MGFkaXF6a2N4"}
            }]
        },
        "event": {"timepoint": 632992, "published_at": "2021-01-25T12:28:00", "type": "changed"}
    }
]
